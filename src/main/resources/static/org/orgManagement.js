...
var addData = function(param){
	operateUtil.addData(addDataUrl,param,addOrEditCompleteFun,"机构新增申请提交成功");
};
/**
 * 校验删除机构是否有子机构
 * @return
...
var editData = function(param){
	operateUtil.editData(addDataUrl,param,addOrEditCompleteFun,"机构编辑申请提交成功");
//	LoadOrgTree();
};
...
var removeData = function(param){
	operateUtil.removeData(addDataUrl,param,addOrEditCompleteFun,"机构删除申请提交成功");
};
